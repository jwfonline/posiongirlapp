...
// add category name clear out the input and hide the modal window
 ...
 // delete category
    ...
    .controller('TypeCtrl', function ($scope, firebaseCollection, guidFactory, $ionicModal) {



        $scope.categories = firebaseCollection('https://amber-inferno-837.firebaseio.com/Category');

        $scope.types = firebaseCollection('https://amber-inferno-837.firebaseio.com/Type');
        ...
        $scope.ShowEdit = function (u, SCategory) {
            $scope.openModal(3);
            $scope.typesToEdit = u;
            $scope.selectedCategory = SCategory;
        };
